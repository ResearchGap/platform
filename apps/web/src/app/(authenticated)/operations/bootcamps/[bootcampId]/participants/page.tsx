...
export default async function OperationsParticipantsPage({
  params,
  searchParams,
}: {
  ...
  const pathname = `/operations/bootcamps/${bootcampId}/participants` as Route;
  return (
    <div className="flex flex-col gap-8">
      <PageHeading
        eyebrow="Participant monitoring"
        title={bootcamp.title}
        description="Review enrolled Mentee information and current enrollment state."
      />
      <FilterNav
